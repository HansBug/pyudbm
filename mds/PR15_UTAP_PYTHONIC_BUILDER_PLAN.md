...
* [ ] builder 主实现放在 `pyudbm/binding/utap_builder.py`
* [ ] `pyudbm/binding/__init__.py` import 并 re-export `ModelBuilder` / `TemplateBuilder`
...
* [ ] spec 主实现继续放在 `pyudbm/binding/utap_builder.py`
* [ ] `pyudbm/binding/__init__.py` import 并 re-export spec 相关 public API
