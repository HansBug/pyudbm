...
.. graphviz:: zone_dbm_mapping_zh.dot

这张图把整个翻译过程放在了一起：左边是几何上的 zone，中间是统一化后的差值约束，右边则是矩阵视角。
...
* :math:`D_{x,x_0} = 5`，表示 :math:`x - x_0 \leq 5`，也就是 :math:`x \leq 5`
* :math:`D_{x_0,y} = 0`，表示 :math:`x_0 - y \leq 0`，也就是 :math:`y \geq 0`
* :math:`D_{x,y} = 2`，表示 :math:`x - y \leq 2`
