...
这一部分是 :doc:`/tutorials/installation/index_zh` 的概念层补充。它主要不是用来讲安装步骤或命令流程，
而是用来解释 UPPAAL 里的核心概念到底是什么意思、为什么需要它们，以及这些概念和 :mod:`pyudbm`
未来的 Python 侧方向有什么关系。
...
如果你最关心的是这个仓库未来的 Python API 会怎样映射这些概念：
    也建议先读 :doc:`../what-is-uppaal/index_zh`，因为它解释了被恢复的
